...
import type { ApiUsersStatusData, ApiUsersStatusResponses, PlayerData, PlayerResponses, PlayerTopNbPerfTypeData, PlayerTopNbPerfTypeResponses, ApiUserData, ApiUserResponses, ApiUserRatingHistoryData, ApiUserRatingHistoryResponses, ApiUserPerfData, ApiUserPerfResponses, ApiUserActivityData, ApiUserActivityResponses, ApiPuzzleDailyData, ApiPuzzleDailyResponses, ApiPuzzleIdData, ApiPuzzleIdResponses, ApiPuzzleNextData, ApiPuzzleNextResponses, ApiPuzzleActivityData, ApiPuzzleActivityResponses, ApiPuzzleReplayData, ApiPuzzleReplayResponses, ApiPuzzleReplayErrors, ApiPuzzleDashboardData, ApiPuzzleDashboardResponses, ApiStormDashboardData, ApiStormDashboardResponses, RacerPostData, RacerPostResponses, ApiUsersData, ApiUsersResponses, AccountMeData, AccountMeResponses, AccountEmailData, AccountEmailResponses, AccountData, AccountResponses, AccountKidData, AccountKidResponses, AccountKidPostData, AccountKidPostResponses, TimelineData, TimelineResponses, GamePgnData, GamePgnResponses, ApiUserCurrentGameData, ApiUserCurrentGameResponses, ApiGamesUserData, ApiGamesUserResponses, GamesExportIdsData, GamesExportIdsResponses, GamesByUsersData, GamesByUsersResponses, GamesByIdsData, GamesByIdsResponses, GamesByIdsAddData, GamesByIdsAddResponses, ApiAccountPlayingData, ApiAccountPlayingResponses, StreamGameData, StreamGameResponses, GameImportData, GameImportResponses, ApiImportedGamesUserData, ApiImportedGamesUserResponses, ApiExportBookmarksData, ApiExportBookmarksResponses, TvChannelsData, TvChannelsResponses, TvFeedData, TvFeedResponses, TvChannelFeedData, TvChannelFeedResponses, TvChannelGamesData, TvChannelGamesResponses, ApiTournamentData, ApiTournamentResponses, ApiTournamentPostData, ApiTournamentPostResponses, ApiTournamentPostErrors, TournamentData, TournamentResponses, ApiTournamentUpdateData, ApiTournamentUpdateResponses, ApiTournamentUpdateErrors, ApiTournamentJoinData, ApiTournamentJoinResponses, ApiTournamentJoinErrors, ApiTournamentWithdrawData, ApiTournamentWithdrawResponses, ApiTournamentWithdrawErrors, ApiTournamentTerminateData, ApiTournamentTerminateResponses, ApiTournamentTerminateErrors, ApiTournamentTeamBattlePostData, ApiTournamentTeamBattlePostResponses, ApiTournamentTeamBattlePostErrors, GamesByTournamentData, GamesByTournamentResponses, ResultsByTournamentData, ResultsByTournamentResponses, TeamsByTournamentData, TeamsByTournamentResponses, ApiUserNameTournamentCreatedData, ApiUserNameTournamentCreatedResponses, ApiUserNameTournamentPlayedData, ApiUserNameTournamentPlayedResponses, ApiSwissNewData, ApiSwissNewResponses, ApiSwissNewErrors, SwissData, SwissResponses, ApiSwissUpdateData, ApiSwissUpdateResponses, ApiSwissUpdateErrors, ApiSwissScheduleNextRoundData, ApiSwissScheduleNextRoundResponses, ApiSwissScheduleNextRoundErrors, ApiSwissJoinData, ApiSwissJoinResponses, ApiSwissJoinErrors, ApiSwissWithdrawData, ApiSwissWithdrawResponses, ApiSwissTerminateData, ApiSwissTerminateResponses, ApiSwissTerminateErrors, SwissTrfData, SwissTrfResponses, GamesBySwissData, GamesBySwissResponses, ResultsBySwissData, ResultsBySwissResponses, ApiTeamSwissData, ApiTeamSwissResponses, StudyChapterPgnData, StudyChapterPgnResponses, StudyAllChaptersPgnData, StudyAllChaptersPgnResponses, StudyAllChaptersHeadData, StudyAllChaptersHeadResponses, ApiStudyImportPgnData, ApiStudyImportPgnResponses, ApiStudyImportPgnErrors, StudyExportAllPgnData, StudyExportAllPgnResponses, StudyListMetadataData, StudyListMetadataResponses, ApiStudyStudyIdChapterIdDeleteData, ApiStudyStudyIdChapterIdDeleteResponses, BroadcastsOfficialData, BroadcastsOfficialResponses, BroadcastsTopData, BroadcastsTopResponses, BroadcastsByUserData, BroadcastsByUserResponses, BroadcastsSearchData, BroadcastsSearchResponses, BroadcastTourCreateData, BroadcastTourCreateResponses, BroadcastTourCreateErrors, BroadcastTourGetData, BroadcastTourGetResponses, BroadcastPlayersGetData, BroadcastPlayersGetResponses, BroadcastTourUpdateData, BroadcastTourUpdateResponses, BroadcastTourUpdateErrors, BroadcastRoundCreateData, BroadcastRoundCreateResponses, BroadcastRoundCreateErrors, BroadcastRoundGetData, BroadcastRoundGetResponses, BroadcastRoundUpdateData, BroadcastRoundUpdateResponses, BroadcastRoundUpdateErrors, BroadcastRoundResetData, BroadcastRoundResetResponses, BroadcastPushData, BroadcastPushResponses, BroadcastPushErrors, BroadcastStreamRoundPgnData, BroadcastStreamRoundPgnResponses, BroadcastRoundPgnData, BroadcastRoundPgnResponses, BroadcastAllRoundsPgnData, BroadcastAllRoundsPgnResponses, BroadcastMyRoundsGetData, BroadcastMyRoundsGetResponses, FidePlayerGetData, FidePlayerGetResponses, FidePlayerSearchData, FidePlayerSearchResponses, ApiSimulData, ApiSimulResponses, TeamShowData, TeamShowResponses, TeamAllData, TeamAllResponses, TeamOfUsernameData, TeamOfUsernameResponses, TeamSearchData, TeamSearchResponses, TeamIdUsersData, TeamIdUsersResponses, ApiTeamArenaData, ApiTeamArenaResponses, TeamIdJoinData, TeamIdJoinResponses, TeamIdQuitData, TeamIdQuitResponses, TeamRequestsData, TeamRequestsResponses, TeamRequestAcceptData, TeamRequestAcceptResponses, TeamRequestDeclineData, TeamRequestDeclineResponses, TeamIdKickUserIdData, TeamIdKickUserIdResponses, TeamIdPmAllData, TeamIdPmAllResponses, TeamIdPmAllErrors, StreamerLiveData, StreamerLiveResponses, ApiCrosstableData, ApiCrosstableResponses, ApiPlayerAutocompleteData, ApiPlayerAutocompleteResponses, ReadNoteData, ReadNoteResponses, WriteNoteData, WriteNoteResponses, ApiUserFollowingData, ApiUserFollowingResponses, FollowUserData, FollowUserResponses, UnfollowUserData, UnfollowUserResponses, BlockUserData, BlockUserResponses, UnblockUserData, UnblockUserResponses, ApiStreamEventData, ApiStreamEventResponses, ApiBoardSeekData, ApiBoardSeekResponses, ApiBoardSeekErrors, BoardGameStreamData, BoardGameStreamResponses, BoardGameStreamErrors, BoardGameMoveData, BoardGameMoveResponses, BoardGameMoveErrors, BoardGameChatGetData, BoardGameChatGetResponses, BoardGameChatPostData, BoardGameChatPostResponses, BoardGameChatPostErrors, BoardGameAbortData, BoardGameAbortResponses, BoardGameAbortErrors, BoardGameResignData, BoardGameResignResponses, BoardGameResignErrors, BoardGameDrawData, BoardGameDrawResponses, BoardGameDrawErrors, BoardGameTakebackData, BoardGameTakebackResponses, BoardGameTakebackErrors, BoardGameClaimVictoryData, BoardGameClaimVictoryResponses, BoardGameClaimVictoryErrors, BoardGameBerserkData, BoardGameBerserkResponses, BoardGameBerserkErrors, ApiBotOnlineData, ApiBotOnlineResponses, BotAccountUpgradeData, BotAccountUpgradeResponses, BotAccountUpgradeErrors, BotGameStreamData, BotGameStreamResponses, BotGameStreamErrors, BotGameMoveData, BotGameMoveResponses, BotGameMoveErrors, BotGameChatGetData, BotGameChatGetResponses, BotGameChatData, BotGameChatResponses, BotGameChatErrors, BotGameAbortData, BotGameAbortResponses, BotGameAbortErrors, BotGameResignData, BotGameResignResponses, BotGameResignErrors, BotGameDrawData, BotGameDrawResponses, BotGameDrawErrors, BotGameTakebackData, BotGameTakebackResponses, BotGameTakebackErrors, BotGameClaimVictoryData, BotGameClaimVictoryResponses, BotGameClaimVictoryErrors, ChallengeListData, ChallengeListResponses, ChallengeCreateData, ChallengeCreateResponses, ChallengeCreateErrors, ChallengeShowData, ChallengeShowResponses, ChallengeAcceptData, ChallengeAcceptResponses, ChallengeAcceptErrors, ChallengeDeclineData, ChallengeDeclineResponses, ChallengeDeclineErrors, ChallengeCancelData, ChallengeCancelResponses, ChallengeCancelErrors, ChallengeAiData, ChallengeAiResponses, ChallengeAiErrors, ChallengeOpenData, ChallengeOpenResponses, ChallengeOpenErrors, ChallengeStartClocksData, ChallengeStartClocksResponses, BulkPairingListData, BulkPairingListResponses, BulkPairingCreateData, BulkPairingCreateResponses, BulkPairingCreateErrors, BulkPairingStartClocksData, BulkPairingStartClocksResponses, BulkPairingStartClocksErrors, BulkPairingDeleteData, BulkPairingDeleteResponses, BulkPairingDeleteErrors, BulkPairingGetData, BulkPairingGetResponses, BulkPairingGetErrors, BulkPairingIdGamesGetData, BulkPairingIdGamesGetResponses, RoundAddTimeData, RoundAddTimeResponses, AdminChallengeTokensData, AdminChallengeTokensResponses, AdminChallengeTokensErrors, InboxUsernameData, InboxUsernameResponses, InboxUsernameErrors, ApiCloudEvalData, ApiCloudEvalResponses, ApiCloudEvalErrors, ApiExternalEngineListData, ApiExternalEngineListResponses, ApiExternalEngineCreateData, ApiExternalEngineCreateResponses, ApiExternalEngineDeleteData, ApiExternalEngineDeleteResponses, ApiExternalEngineGetData, ApiExternalEngineGetResponses, ApiExternalEnginePutData, ApiExternalEnginePutResponses, ApiExternalEngineAnalyseData, ApiExternalEngineAnalyseResponses, ApiExternalEngineAcquireData, ApiExternalEngineAcquireResponses, ApiExternalEngineSubmitData, ApiExternalEngineSubmitResponses, OauthData, OauthResponses, ApiTokenDeleteData, ApiTokenDeleteResponses, ApiTokenData, ApiTokenResponses, ApiTokenErrors, TokenTestData, TokenTestResponses, OpeningExplorerMasterData, OpeningExplorerMasterResponses, OpeningExplorerLichessData, OpeningExplorerLichessResponses, OpeningExplorerPlayerData, OpeningExplorerPlayerResponses, OpeningExplorerMasterGameData, OpeningExplorerMasterGameResponses, TablebaseStandardData, TablebaseStandardResponses, TablebaseAtomicData, TablebaseAtomicResponses, AntichessAtomicData, AntichessAtomicResponses } from './types.gen';
...
export const apiUsersStatus = <ThrowOnError extends boolean = false>(options: Options<ApiUsersStatusData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiUsersStatusResponses, unknown, ThrowOnError>({
...
export const player = <ThrowOnError extends boolean = false>(options?: Options<PlayerData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<PlayerResponses, unknown, ThrowOnError>({
        url: '/api/player',
        ...options
    });
};
...
export const playerTopNbPerfType = <ThrowOnError extends boolean = false>(options: Options<PlayerTopNbPerfTypeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<PlayerTopNbPerfTypeResponses, unknown, ThrowOnError>({
...
export const apiUser = <ThrowOnError extends boolean = false>(options: Options<ApiUserData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiUserResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiUserRatingHistory = <ThrowOnError extends boolean = false>(options: Options<ApiUserRatingHistoryData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiUserRatingHistoryResponses, unknown, ThrowOnError>({
...
export const apiUserPerf = <ThrowOnError extends boolean = false>(options: Options<ApiUserPerfData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiUserPerfResponses, unknown, ThrowOnError>({
...
export const apiUserActivity = <ThrowOnError extends boolean = false>(options: Options<ApiUserActivityData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiUserActivityResponses, unknown, ThrowOnError>({
...
export const apiPuzzleDaily = <ThrowOnError extends boolean = false>(options?: Options<ApiPuzzleDailyData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ApiPuzzleDailyResponses, unknown, ThrowOnError>({
...
export const apiPuzzleId = <ThrowOnError extends boolean = false>(options: Options<ApiPuzzleIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiPuzzleIdResponses, unknown, ThrowOnError>({
        url: '/api/puzzle/{id}',
        ...options
    });
};
...
export const apiPuzzleNext = <ThrowOnError extends boolean = false>(options?: Options<ApiPuzzleNextData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ApiPuzzleNextResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiPuzzleActivity = <ThrowOnError extends boolean = false>(options?: Options<ApiPuzzleActivityData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ApiPuzzleActivityResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiPuzzleReplay = <ThrowOnError extends boolean = false>(options: Options<ApiPuzzleReplayData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiPuzzleReplayResponses, ApiPuzzleReplayErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiPuzzleDashboard = <ThrowOnError extends boolean = false>(options: Options<ApiPuzzleDashboardData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiPuzzleDashboardResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiStormDashboard = <ThrowOnError extends boolean = false>(options: Options<ApiStormDashboardData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiStormDashboardResponses, unknown, ThrowOnError>({
...
export const racerPost = <ThrowOnError extends boolean = false>(options?: Options<RacerPostData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<RacerPostResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiUsers = <ThrowOnError extends boolean = false>(options: Options<ApiUsersData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApiUsersResponses, unknown, ThrowOnError>({
        bodySerializer: null,
        url: '/api/users',
        ...options,
        headers: {
...
export const accountMe = <ThrowOnError extends boolean = false>(options?: Options<AccountMeData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<AccountMeResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const accountEmail = <ThrowOnError extends boolean = false>(options?: Options<AccountEmailData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<AccountEmailResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const account = <ThrowOnError extends boolean = false>(options?: Options<AccountData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<AccountResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const accountKid = <ThrowOnError extends boolean = false>(options?: Options<AccountKidData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<AccountKidResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const accountKidPost = <ThrowOnError extends boolean = false>(options: Options<AccountKidPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<AccountKidPostResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const timeline = <ThrowOnError extends boolean = false>(options?: Options<TimelineData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<TimelineResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const gamePgn = <ThrowOnError extends boolean = false>(options: Options<GamePgnData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GamePgnResponses, unknown, ThrowOnError>({
...
export const apiUserCurrentGame = <ThrowOnError extends boolean = false>(options: Options<ApiUserCurrentGameData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiUserCurrentGameResponses, unknown, ThrowOnError>({
...
export const apiGamesUser = <ThrowOnError extends boolean = false>(options: Options<ApiGamesUserData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiGamesUserResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const gamesExportIds = <ThrowOnError extends boolean = false>(options: Options<GamesExportIdsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<GamesExportIdsResponses, unknown, ThrowOnError>({
        bodySerializer: null,
...
export const gamesByUsers = <ThrowOnError extends boolean = false>(options: Options<GamesByUsersData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<GamesByUsersResponses, unknown, ThrowOnError>({
        bodySerializer: null,
...
export const gamesByIds = <ThrowOnError extends boolean = false>(options: Options<GamesByIdsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<GamesByIdsResponses, unknown, ThrowOnError>({
        bodySerializer: null,
...
export const gamesByIdsAdd = <ThrowOnError extends boolean = false>(options: Options<GamesByIdsAddData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<GamesByIdsAddResponses, unknown, ThrowOnError>({
        bodySerializer: null,
...
export const apiAccountPlaying = <ThrowOnError extends boolean = false>(options?: Options<ApiAccountPlayingData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ApiAccountPlayingResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const streamGame = <ThrowOnError extends boolean = false>(options: Options<StreamGameData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<StreamGameResponses, unknown, ThrowOnError>({
...
export const gameImport = <ThrowOnError extends boolean = false>(options: Options<GameImportData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<GameImportResponses, unknown, ThrowOnError>({
...
export const apiImportedGamesUser = <ThrowOnError extends boolean = false>(options?: Options<ApiImportedGamesUserData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ApiImportedGamesUserResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiExportBookmarks = <ThrowOnError extends boolean = false>(options?: Options<ApiExportBookmarksData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ApiExportBookmarksResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const tvChannels = <ThrowOnError extends boolean = false>(options?: Options<TvChannelsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<TvChannelsResponses, unknown, ThrowOnError>({
        url: '/api/tv/channels',
        ...options
    });
};
...
export const tvFeed = <ThrowOnError extends boolean = false>(options?: Options<TvFeedData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<TvFeedResponses, unknown, ThrowOnError>({
        url: '/api/tv/feed',
        ...options
    });
};
...
export const tvChannelFeed = <ThrowOnError extends boolean = false>(options: Options<TvChannelFeedData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<TvChannelFeedResponses, unknown, ThrowOnError>({
...
export const tvChannelGames = <ThrowOnError extends boolean = false>(options: Options<TvChannelGamesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<TvChannelGamesResponses, unknown, ThrowOnError>({
        url: '/api/tv/{channel}',
        ...options
    });
};
...
export const apiTournament = <ThrowOnError extends boolean = false>(options?: Options<ApiTournamentData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ApiTournamentResponses, unknown, ThrowOnError>({
        url: '/api/tournament',
        ...options
    });
};
...
export const apiTournamentPost = <ThrowOnError extends boolean = false>(options: Options<ApiTournamentPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApiTournamentPostResponses, ApiTournamentPostErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const tournament = <ThrowOnError extends boolean = false>(options: Options<TournamentData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<TournamentResponses, unknown, ThrowOnError>({
...
export const apiTournamentUpdate = <ThrowOnError extends boolean = false>(options: Options<ApiTournamentUpdateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApiTournamentUpdateResponses, ApiTournamentUpdateErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const apiTournamentJoin = <ThrowOnError extends boolean = false>(options: Options<ApiTournamentJoinData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApiTournamentJoinResponses, ApiTournamentJoinErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const apiTournamentWithdraw = <ThrowOnError extends boolean = false>(options: Options<ApiTournamentWithdrawData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApiTournamentWithdrawResponses, ApiTournamentWithdrawErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiTournamentTerminate = <ThrowOnError extends boolean = false>(options: Options<ApiTournamentTerminateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApiTournamentTerminateResponses, ApiTournamentTerminateErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiTournamentTeamBattlePost = <ThrowOnError extends boolean = false>(options: Options<ApiTournamentTeamBattlePostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApiTournamentTeamBattlePostResponses, ApiTournamentTeamBattlePostErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const gamesByTournament = <ThrowOnError extends boolean = false>(options: Options<GamesByTournamentData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GamesByTournamentResponses, unknown, ThrowOnError>({
...
export const resultsByTournament = <ThrowOnError extends boolean = false>(options: Options<ResultsByTournamentData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ResultsByTournamentResponses, unknown, ThrowOnError>({
...
export const teamsByTournament = <ThrowOnError extends boolean = false>(options: Options<TeamsByTournamentData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<TeamsByTournamentResponses, unknown, ThrowOnError>({
...
export const apiUserNameTournamentCreated = <ThrowOnError extends boolean = false>(options: Options<ApiUserNameTournamentCreatedData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiUserNameTournamentCreatedResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiUserNameTournamentPlayed = <ThrowOnError extends boolean = false>(options: Options<ApiUserNameTournamentPlayedData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiUserNameTournamentPlayedResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiSwissNew = <ThrowOnError extends boolean = false>(options: Options<ApiSwissNewData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApiSwissNewResponses, ApiSwissNewErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const swiss = <ThrowOnError extends boolean = false>(options: Options<SwissData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<SwissResponses, unknown, ThrowOnError>({
        url: '/api/swiss/{id}',
        ...options
    });
};
...
export const apiSwissUpdate = <ThrowOnError extends boolean = false>(options: Options<ApiSwissUpdateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApiSwissUpdateResponses, ApiSwissUpdateErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const apiSwissScheduleNextRound = <ThrowOnError extends boolean = false>(options: Options<ApiSwissScheduleNextRoundData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApiSwissScheduleNextRoundResponses, ApiSwissScheduleNextRoundErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const apiSwissJoin = <ThrowOnError extends boolean = false>(options: Options<ApiSwissJoinData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApiSwissJoinResponses, ApiSwissJoinErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const apiSwissWithdraw = <ThrowOnError extends boolean = false>(options: Options<ApiSwissWithdrawData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApiSwissWithdrawResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiSwissTerminate = <ThrowOnError extends boolean = false>(options: Options<ApiSwissTerminateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApiSwissTerminateResponses, ApiSwissTerminateErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const swissTrf = <ThrowOnError extends boolean = false>(options: Options<SwissTrfData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<SwissTrfResponses, unknown, ThrowOnError>({
        url: '/swiss/{id}.trf',
        ...options
    });
};
...
export const gamesBySwiss = <ThrowOnError extends boolean = false>(options: Options<GamesBySwissData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GamesBySwissResponses, unknown, ThrowOnError>({
...
export const resultsBySwiss = <ThrowOnError extends boolean = false>(options: Options<ResultsBySwissData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ResultsBySwissResponses, unknown, ThrowOnError>({
...
export const apiTeamSwiss = <ThrowOnError extends boolean = false>(options: Options<ApiTeamSwissData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiTeamSwissResponses, unknown, ThrowOnError>({
...
export const studyChapterPgn = <ThrowOnError extends boolean = false>(options: Options<StudyChapterPgnData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<StudyChapterPgnResponses, unknown, ThrowOnError>({
...
export const studyAllChaptersPgn = <ThrowOnError extends boolean = false>(options: Options<StudyAllChaptersPgnData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<StudyAllChaptersPgnResponses, unknown, ThrowOnError>({
...
export const studyAllChaptersHead = <ThrowOnError extends boolean = false>(options: Options<StudyAllChaptersHeadData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).head<StudyAllChaptersHeadResponses, unknown, ThrowOnError>({
        url: '/api/study/{studyId}.pgn',
        ...options
    });
};
...
export const apiStudyImportPgn = <ThrowOnError extends boolean = false>(options: Options<ApiStudyImportPgnData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApiStudyImportPgnResponses, ApiStudyImportPgnErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const studyExportAllPgn = <ThrowOnError extends boolean = false>(options: Options<StudyExportAllPgnData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<StudyExportAllPgnResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const studyListMetadata = <ThrowOnError extends boolean = false>(options: Options<StudyListMetadataData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<StudyListMetadataResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiStudyStudyIdChapterIdDelete = <ThrowOnError extends boolean = false>(options: Options<ApiStudyStudyIdChapterIdDeleteData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<ApiStudyStudyIdChapterIdDeleteResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const broadcastsOfficial = <ThrowOnError extends boolean = false>(options?: Options<BroadcastsOfficialData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<BroadcastsOfficialResponses, unknown, ThrowOnError>({
        url: '/api/broadcast',
        ...options
    });
};
...
export const broadcastsTop = <ThrowOnError extends boolean = false>(options?: Options<BroadcastsTopData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<BroadcastsTopResponses, unknown, ThrowOnError>({
...
export const broadcastsByUser = <ThrowOnError extends boolean = false>(options: Options<BroadcastsByUserData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<BroadcastsByUserResponses, unknown, ThrowOnError>({
 ...
 *
 */
export const broadcastsSearch = <ThrowOnError extends boolean = false>(options?: Options<BroadcastsSearchData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<BroadcastsSearchResponses, unknown, ThrowOnError>({
...
export const broadcastTourCreate = <ThrowOnError extends boolean = false>(options: Options<BroadcastTourCreateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BroadcastTourCreateResponses, BroadcastTourCreateErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const broadcastTourGet = <ThrowOnError extends boolean = false>(options: Options<BroadcastTourGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<BroadcastTourGetResponses, unknown, ThrowOnError>({
...
export const broadcastPlayersGet = <ThrowOnError extends boolean = false>(options: Options<BroadcastPlayersGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<BroadcastPlayersGetResponses, unknown, ThrowOnError>({
...
export const broadcastTourUpdate = <ThrowOnError extends boolean = false>(options: Options<BroadcastTourUpdateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BroadcastTourUpdateResponses, BroadcastTourUpdateErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const broadcastRoundCreate = <ThrowOnError extends boolean = false>(options: Options<BroadcastRoundCreateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BroadcastRoundCreateResponses, BroadcastRoundCreateErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const broadcastRoundGet = <ThrowOnError extends boolean = false>(options: Options<BroadcastRoundGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<BroadcastRoundGetResponses, unknown, ThrowOnError>({
...
export const broadcastRoundUpdate = <ThrowOnError extends boolean = false>(options: Options<BroadcastRoundUpdateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BroadcastRoundUpdateResponses, BroadcastRoundUpdateErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const broadcastRoundReset = <ThrowOnError extends boolean = false>(options: Options<BroadcastRoundResetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BroadcastRoundResetResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const broadcastPush = <ThrowOnError extends boolean = false>(options: Options<BroadcastPushData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BroadcastPushResponses, BroadcastPushErrors, ThrowOnError>({
        bodySerializer: null,
        security: [
            {
                scheme: 'bearer',
...
export const broadcastStreamRoundPgn = <ThrowOnError extends boolean = false>(options: Options<BroadcastStreamRoundPgnData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<BroadcastStreamRoundPgnResponses, unknown, ThrowOnError>({
...
export const broadcastRoundPgn = <ThrowOnError extends boolean = false>(options: Options<BroadcastRoundPgnData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<BroadcastRoundPgnResponses, unknown, ThrowOnError>({
...
export const broadcastAllRoundsPgn = <ThrowOnError extends boolean = false>(options: Options<BroadcastAllRoundsPgnData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<BroadcastAllRoundsPgnResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const broadcastMyRoundsGet = <ThrowOnError extends boolean = false>(options?: Options<BroadcastMyRoundsGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<BroadcastMyRoundsGetResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const fidePlayerGet = <ThrowOnError extends boolean = false>(options: Options<FidePlayerGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FidePlayerGetResponses, unknown, ThrowOnError>({
...
export const fidePlayerSearch = <ThrowOnError extends boolean = false>(options: Options<FidePlayerSearchData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<FidePlayerSearchResponses, unknown, ThrowOnError>({
        url: '/api/fide/player',
        ...options
    });
};
...
export const apiSimul = <ThrowOnError extends boolean = false>(options?: Options<ApiSimulData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ApiSimulResponses, unknown, ThrowOnError>({
        url: '/api/simul',
        ...options
    });
};
...
export const teamShow = <ThrowOnError extends boolean = false>(options: Options<TeamShowData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<TeamShowResponses, unknown, ThrowOnError>({
        url: '/api/team/{teamId}',
        ...options
    });
};
...
export const teamAll = <ThrowOnError extends boolean = false>(options?: Options<TeamAllData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<TeamAllResponses, unknown, ThrowOnError>({
        url: '/api/team/all',
        ...options
    });
};
...
export const teamOfUsername = <ThrowOnError extends boolean = false>(options: Options<TeamOfUsernameData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<TeamOfUsernameResponses, unknown, ThrowOnError>({
...
export const teamSearch = <ThrowOnError extends boolean = false>(options?: Options<TeamSearchData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<TeamSearchResponses, unknown, ThrowOnError>({
        url: '/api/team/search',
        ...options
    });
};
...
export const teamIdUsers = <ThrowOnError extends boolean = false>(options: Options<TeamIdUsersData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<TeamIdUsersResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiTeamArena = <ThrowOnError extends boolean = false>(options: Options<ApiTeamArenaData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiTeamArenaResponses, unknown, ThrowOnError>({
...
export const teamIdJoin = <ThrowOnError extends boolean = false>(options: Options<TeamIdJoinData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<TeamIdJoinResponses, unknown, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const teamIdQuit = <ThrowOnError extends boolean = false>(options: Options<TeamIdQuitData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<TeamIdQuitResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const teamRequests = <ThrowOnError extends boolean = false>(options: Options<TeamRequestsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<TeamRequestsResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const teamRequestAccept = <ThrowOnError extends boolean = false>(options: Options<TeamRequestAcceptData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<TeamRequestAcceptResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const teamRequestDecline = <ThrowOnError extends boolean = false>(options: Options<TeamRequestDeclineData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<TeamRequestDeclineResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const teamIdKickUserId = <ThrowOnError extends boolean = false>(options: Options<TeamIdKickUserIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<TeamIdKickUserIdResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const teamIdPmAll = <ThrowOnError extends boolean = false>(options: Options<TeamIdPmAllData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<TeamIdPmAllResponses, TeamIdPmAllErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const streamerLive = <ThrowOnError extends boolean = false>(options?: Options<StreamerLiveData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<StreamerLiveResponses, unknown, ThrowOnError>({
...
export const apiCrosstable = <ThrowOnError extends boolean = false>(options: Options<ApiCrosstableData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiCrosstableResponses, unknown, ThrowOnError>({
...
export const apiPlayerAutocomplete = <ThrowOnError extends boolean = false>(options: Options<ApiPlayerAutocompleteData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiPlayerAutocompleteResponses, unknown, ThrowOnError>({
...
export const readNote = <ThrowOnError extends boolean = false>(options: Options<ReadNoteData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ReadNoteResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const writeNote = <ThrowOnError extends boolean = false>(options: Options<WriteNoteData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<WriteNoteResponses, unknown, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const apiUserFollowing = <ThrowOnError extends boolean = false>(options?: Options<ApiUserFollowingData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ApiUserFollowingResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const blockUser = <ThrowOnError extends boolean = false>(options: Options<BlockUserData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BlockUserResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const unblockUser = <ThrowOnError extends boolean = false>(options: Options<UnblockUserData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<UnblockUserResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiStreamEvent = <ThrowOnError extends boolean = false>(options?: Options<ApiStreamEventData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ApiStreamEventResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiBoardSeek = <ThrowOnError extends boolean = false>(options?: Options<ApiBoardSeekData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<ApiBoardSeekResponses, ApiBoardSeekErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const boardGameStream = <ThrowOnError extends boolean = false>(options: Options<BoardGameStreamData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<BoardGameStreamResponses, BoardGameStreamErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const boardGameMove = <ThrowOnError extends boolean = false>(options: Options<BoardGameMoveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BoardGameMoveResponses, BoardGameMoveErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const boardGameChatGet = <ThrowOnError extends boolean = false>(options: Options<BoardGameChatGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<BoardGameChatGetResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const boardGameChatPost = <ThrowOnError extends boolean = false>(options: Options<BoardGameChatPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BoardGameChatPostResponses, BoardGameChatPostErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const boardGameAbort = <ThrowOnError extends boolean = false>(options: Options<BoardGameAbortData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BoardGameAbortResponses, BoardGameAbortErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const boardGameResign = <ThrowOnError extends boolean = false>(options: Options<BoardGameResignData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BoardGameResignResponses, BoardGameResignErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const boardGameDraw = <ThrowOnError extends boolean = false>(options: Options<BoardGameDrawData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BoardGameDrawResponses, BoardGameDrawErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const boardGameTakeback = <ThrowOnError extends boolean = false>(options: Options<BoardGameTakebackData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BoardGameTakebackResponses, BoardGameTakebackErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const boardGameClaimVictory = <ThrowOnError extends boolean = false>(options: Options<BoardGameClaimVictoryData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BoardGameClaimVictoryResponses, BoardGameClaimVictoryErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const boardGameBerserk = <ThrowOnError extends boolean = false>(options: Options<BoardGameBerserkData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BoardGameBerserkResponses, BoardGameBerserkErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiBotOnline = <ThrowOnError extends boolean = false>(options?: Options<ApiBotOnlineData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ApiBotOnlineResponses, unknown, ThrowOnError>({
        url: '/api/bot/online',
        ...options
    });
};
...
export const botAccountUpgrade = <ThrowOnError extends boolean = false>(options?: Options<BotAccountUpgradeData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<BotAccountUpgradeResponses, BotAccountUpgradeErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const botGameStream = <ThrowOnError extends boolean = false>(options: Options<BotGameStreamData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<BotGameStreamResponses, BotGameStreamErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const botGameMove = <ThrowOnError extends boolean = false>(options: Options<BotGameMoveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BotGameMoveResponses, BotGameMoveErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const botGameChatGet = <ThrowOnError extends boolean = false>(options: Options<BotGameChatGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<BotGameChatGetResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const botGameChat = <ThrowOnError extends boolean = false>(options: Options<BotGameChatData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BotGameChatResponses, BotGameChatErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const botGameAbort = <ThrowOnError extends boolean = false>(options: Options<BotGameAbortData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BotGameAbortResponses, BotGameAbortErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const botGameResign = <ThrowOnError extends boolean = false>(options: Options<BotGameResignData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BotGameResignResponses, BotGameResignErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const botGameDraw = <ThrowOnError extends boolean = false>(options: Options<BotGameDrawData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BotGameDrawResponses, BotGameDrawErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const botGameTakeback = <ThrowOnError extends boolean = false>(options: Options<BotGameTakebackData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BotGameTakebackResponses, BotGameTakebackErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const botGameClaimVictory = <ThrowOnError extends boolean = false>(options: Options<BotGameClaimVictoryData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BotGameClaimVictoryResponses, BotGameClaimVictoryErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const challengeList = <ThrowOnError extends boolean = false>(options?: Options<ChallengeListData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ChallengeListResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const challengeCreate = <ThrowOnError extends boolean = false>(options: Options<ChallengeCreateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ChallengeCreateResponses, ChallengeCreateErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const challengeShow = <ThrowOnError extends boolean = false>(options: Options<ChallengeShowData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ChallengeShowResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const challengeAccept = <ThrowOnError extends boolean = false>(options: Options<ChallengeAcceptData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ChallengeAcceptResponses, ChallengeAcceptErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const challengeDecline = <ThrowOnError extends boolean = false>(options: Options<ChallengeDeclineData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ChallengeDeclineResponses, ChallengeDeclineErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const challengeCancel = <ThrowOnError extends boolean = false>(options: Options<ChallengeCancelData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ChallengeCancelResponses, ChallengeCancelErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const challengeAi = <ThrowOnError extends boolean = false>(options: Options<ChallengeAiData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ChallengeAiResponses, ChallengeAiErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const challengeOpen = <ThrowOnError extends boolean = false>(options?: Options<ChallengeOpenData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<ChallengeOpenResponses, ChallengeOpenErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
...
export const challengeStartClocks = <ThrowOnError extends boolean = false>(options: Options<ChallengeStartClocksData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ChallengeStartClocksResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const bulkPairingList = <ThrowOnError extends boolean = false>(options?: Options<BulkPairingListData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<BulkPairingListResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const bulkPairingCreate = <ThrowOnError extends boolean = false>(options: Options<BulkPairingCreateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BulkPairingCreateResponses, BulkPairingCreateErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const bulkPairingStartClocks = <ThrowOnError extends boolean = false>(options: Options<BulkPairingStartClocksData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BulkPairingStartClocksResponses, BulkPairingStartClocksErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const bulkPairingDelete = <ThrowOnError extends boolean = false>(options: Options<BulkPairingDeleteData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<BulkPairingDeleteResponses, BulkPairingDeleteErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const bulkPairingGet = <ThrowOnError extends boolean = false>(options: Options<BulkPairingGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<BulkPairingGetResponses, BulkPairingGetErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const bulkPairingIdGamesGet = <ThrowOnError extends boolean = false>(options: Options<BulkPairingIdGamesGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<BulkPairingIdGamesGetResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const roundAddTime = <ThrowOnError extends boolean = false>(options: Options<RoundAddTimeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<RoundAddTimeResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const adminChallengeTokens = <ThrowOnError extends boolean = false>(options: Options<AdminChallengeTokensData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<AdminChallengeTokensResponses, AdminChallengeTokensErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const inboxUsername = <ThrowOnError extends boolean = false>(options: Options<InboxUsernameData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<InboxUsernameResponses, InboxUsernameErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        security: [
            {
                scheme: 'bearer',
...
export const apiCloudEval = <ThrowOnError extends boolean = false>(options: Options<ApiCloudEvalData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiCloudEvalResponses, ApiCloudEvalErrors, ThrowOnError>({
        url: '/api/cloud-eval',
        ...options
    });
};
...
export const apiExternalEngineList = <ThrowOnError extends boolean = false>(options?: Options<ApiExternalEngineListData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ApiExternalEngineListResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiExternalEngineCreate = <ThrowOnError extends boolean = false>(options: Options<ApiExternalEngineCreateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApiExternalEngineCreateResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiExternalEngineDelete = <ThrowOnError extends boolean = false>(options: Options<ApiExternalEngineDeleteData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<ApiExternalEngineDeleteResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiExternalEngineGet = <ThrowOnError extends boolean = false>(options: Options<ApiExternalEngineGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiExternalEngineGetResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiExternalEnginePut = <ThrowOnError extends boolean = false>(options: Options<ApiExternalEnginePutData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<ApiExternalEnginePutResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiExternalEngineAnalyse = <ThrowOnError extends boolean = false>(options: Options<ApiExternalEngineAnalyseData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApiExternalEngineAnalyseResponses, unknown, ThrowOnError>({
...
export const apiExternalEngineAcquire = <ThrowOnError extends boolean = false>(options: Options<ApiExternalEngineAcquireData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApiExternalEngineAcquireResponses, unknown, ThrowOnError>({
...
export const apiExternalEngineSubmit = <ThrowOnError extends boolean = false>(options: Options<ApiExternalEngineSubmitData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApiExternalEngineSubmitResponses, unknown, ThrowOnError>({
        bodySerializer: null,
...
export const oauth = <ThrowOnError extends boolean = false>(options: Options<OauthData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<OauthResponses, unknown, ThrowOnError>({
        url: '/oauth',
        ...options
    });
};
...
export const apiTokenDelete = <ThrowOnError extends boolean = false>(options?: Options<ApiTokenDeleteData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).delete<ApiTokenDeleteResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const apiToken = <ThrowOnError extends boolean = false>(options: Options<ApiTokenData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApiTokenResponses, ApiTokenErrors, ThrowOnError>({
        ...urlSearchParamsBodySerializer,
        url: '/api/token',
        ...options,
        headers: {
...
export const tokenTest = <ThrowOnError extends boolean = false>(options: Options<TokenTestData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<TokenTestResponses, unknown, ThrowOnError>({
        bodySerializer: null,
        url: '/api/token/test',
        ...options,
        headers: {
...
export const openingExplorerMaster = <ThrowOnError extends boolean = false>(options?: Options<OpeningExplorerMasterData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<OpeningExplorerMasterResponses, unknown, ThrowOnError>({
        url: '/masters',
        ...options
    });
};
...
export const openingExplorerLichess = <ThrowOnError extends boolean = false>(options?: Options<OpeningExplorerLichessData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<OpeningExplorerLichessResponses, unknown, ThrowOnError>({
        url: '/lichess',
        ...options
    });
};
...
export const openingExplorerPlayer = <ThrowOnError extends boolean = false>(options: Options<OpeningExplorerPlayerData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<OpeningExplorerPlayerResponses, unknown, ThrowOnError>({
        url: '/player',
        ...options
    });
};
...
export const openingExplorerMasterGame = <ThrowOnError extends boolean = false>(options: Options<OpeningExplorerMasterGameData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<OpeningExplorerMasterGameResponses, unknown, ThrowOnError>({
...
export const tablebaseStandard = <ThrowOnError extends boolean = false>(options: Options<TablebaseStandardData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<TablebaseStandardResponses, unknown, ThrowOnError>({
        url: '/standard',
        ...options
    });
};
...
export const tablebaseAtomic = <ThrowOnError extends boolean = false>(options: Options<TablebaseAtomicData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<TablebaseAtomicResponses, unknown, ThrowOnError>({
        url: '/atomic',
        ...options
    });
};
...
export const antichessAtomic = <ThrowOnError extends boolean = false>(options: Options<AntichessAtomicData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<AntichessAtomicResponses, unknown, ThrowOnError>({
        url: '/antichess',
        ...options
    });
};