...
export type GameStatusName = 'created' | 'started' | 'aborted' | 'mate' | 'resign' | 'stalemate' | 'timeout' | 'draw' | 'outoftime' | 'cheat' | 'noStart' | 'unknownFinish' | 'variantEnd';
...
export type BroadcastCustomPoints = {
    win: number;
    draw: number;
};
...
export type BroadcastRoundForm = ({
     ...
     */
    rated?: boolean;
    'customScoring.white.win'?: Win;
    'customScoring.white.draw'?: Draw;
    'customScoring.black.win'?: Win;
    'customScoring.black.draw'?: Draw;
    /**
...
export type GameStatusId = 10 | 20 | 25 | 30 | 31 | 32 | 33 | 34 | 35 | 36 | 37 | 38 | 60;
...
export type BroadcastsSearchData = {
    body?: never;
    path?: never;
    query?: {
        /**
...
export type BroadcastsSearchResponses = {
    /**
     * Paginated top broadcast previews.
     */
    200: {
...
export type BroadcastsSearchResponse = BroadcastsSearchResponses[keyof BroadcastsSearchResponses];
